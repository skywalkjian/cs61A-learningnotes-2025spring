...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    final_score=abs(player_score%10-opponent_score//10%10)*3
    if final_score==0:
        return 1
    else:
        return final_score
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    def strategy_ar(score, oppent_score):
        return n
    return strategy_ar
    #summary :高阶函数调用要用多次return
    # END PROBLEM 6
...
def run_experiments():
    ...
    for i in range (1,11):
        print("always_roll(",i,") win rate:", average_win_rate(always_roll(i)))
